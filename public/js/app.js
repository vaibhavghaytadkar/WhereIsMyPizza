...
function initAdmin() {
  var orderTablrBody = document.querySelector('#orderTableBody');
  var orders = [];
  var markup;
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    updateCart(pizza); // console.log('pizza--from app.js' ,pizza);
  });
});
...
updateStatus(order); //client side of socket connection
